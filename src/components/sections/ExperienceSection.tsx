...
const experience = [
  ...
  { time: "03.2023 - Present", title: "Lecturer NodeJS & NextJS", location: "Aptech.", bg: "bg-[#FFF4F4]" },
];

const workHistory = [
  { time: "10.2025 - Present", company: "Madison", title: "Full Stack Software Engineer" },
  { time: "06.2024 - 09.2025", company: "AvePoint", title: "Front-end Software Engineer" },
  { time: "07.2023 - 05.2024", company: "FPT software", title: "Front-end Software Engineer" },
  { time: "05.2021 - 06.2023", company: "Wiicamp", title: "Full Stack Software Engineer" },
  { time: "01.2019 - 05.2021", company: "Orient Software", title: "Software Engineer" },
];
    ...
    <div className="bg-[#F8FBFB]">
      <div className="p-4 sm:p-6 md:p-8" id="experience">
        ...
        <div className="experience-timeline-desktop relative max-w-3xl mx-auto hidden md:block">
          ...
          {/* Item 1 - Left */}
          <div className="relative flex items-center mb-4 sm:mb-6 md:justify-start">
            <TimelineDot position="center" />
            <div className="ml-9 sm:ml-10 md:ml-0 md:w-[45%] md:mr-auto">
              <TimelineCard
          ...
          {/* Work Timeline card - Right */}
          <div className="relative flex items-start md:justify-end">
            <TimelineDot position="center" className="top-3 sm:top-4" />
            <div className="bg-[#EEF5FA] p-3 sm:p-4 rounded-xl ml-9 sm:ml-10 md:ml-0 md:w-[45%] md:ml-auto">
              ...
              {workHistory.map((item, idx) => (
                <div key={idx} className="mb-2 sm:mb-3 last:mb-0">
                  ...
                  <p className="text-[#44566C] text-xs sm:text-sm leading-5 sm:leading-6">{item.company}</p>
        ...
        <div className="experience-mobile md:hidden flex flex-col gap-4">
          {experience.map((item, idx) => (
            <TimelineCard key={idx} time={item.time} title={item.title} subtitle={item.location} bg={item.bg} />
          ))}
